...
This is because N is defined at first so #ifdef is true. So #undef
runs which undefines N. So when f() is run it does the else statement 
and prints "N is undefined"
*/
